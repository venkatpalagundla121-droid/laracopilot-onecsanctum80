...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">View available beds across all locations (Read-Only Access)</p>
</div>
...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
    <div class="flex items-start">
        ...
        <div>
            <p class="text-blue-800 font-semibold">Read-Only Access</p>
            <p class="text-blue-700 text-sm mt-1">You are viewing this dashboard in read-only mode. You can view bed availability but cannot create, edit, or delete any records.</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow p-6 mb-6">
    ...
    <form method="GET" action="{{ route('worker.dashboard') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td colspan="8" class="px-6 py-8 text-center text-gray-500">
                    ...
                    <p class="text-sm text-gray-400 mt-2">All beds are currently occupied</p>
                </td>
            </tr>
            @endforelse
        </tbody>
